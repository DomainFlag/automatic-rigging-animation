...
HumanSkeleton::HumanSkeleton()
{
    ...
    makeJoint("shoulders",  Vector3(0., 0.575, 0.),      "spine");          //2
    ...
    makeJoint("lwrist",     Vector3(-0.6, 0.0, 0.15),   "lelbow");          //6
    makeJoint("lhand",      Vector3(-0.6, -0.025, 0.15),"lwrist");          //7

    makeJoint("rshoulder",  Vector3(0.2, 0.5, 0.),      "shoulders");       //8
    makeJoint("relbow",     Vector3(0.4, 0.25, 0.075),  "rshoulder");       //9
    makeJoint("rwrist",     Vector3(0.6, 0.0, 0.15),    "relbow");          //10
    makeJoint("rhand",      Vector3(0.6, -0.025, 0.15), "rwrist");          //11
