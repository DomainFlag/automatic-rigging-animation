...
struct Vec3Object
{
    Vec3Object(const Pinocchio::Vector3 &inV) : v(inV) {}
    
    Rect3 boundingRect() const { return Rect3(v); }
    double operator[](int i) const { return v[i]; }
    Pinocchio::Vector3 project(const Pinocchio::Vector3 &) const { return v; }
...
struct Tri3Object
{
    Tri3Object(const Pinocchio::Vector3 &inV1, const Pinocchio::Vector3 &inV2, const Pinocchio::Vector3 &inV3) : v1(inV1), v2(inV2), v3(inV3) {}
    ...
    Pinocchio::Vector3 project(const Pinocchio::Vector3 &v) const { return projToTri(v, v1, v2, v3); }
    
    Pinocchio::Vector3 v1, v2, v3;
};
