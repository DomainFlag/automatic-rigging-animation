...
public:
    ...
    Vector(const Real &m1, const Real &m2) { m[0] = m1; m[1] = m2; }
    Vector(const Real &m1, const Real &m2, const Real &m3) { m[0] = m1; m[1] = m2; m[2] = m3; }
    Vector(const Real& m1, const Real& m2, const Real& m3, const Real& m4) { m[0] = m1; m[1] = m2; m[2] = m3; m[3] = m4; }
